...
#SBATCH --output=/work/nvme/becx/yjangir/flow_wm/logs/full_dit_%j.out
#SBATCH --error=/work/nvme/becx/yjangir/flow_wm/logs/full_dit_%j.err
...
echo "[launch] config: train_full_dit_8gpu.json"

# ---- launch -----------------------------------------------------------
# For a single-node job, we do not need `srun` or multi-node networking flags.
accelerate launch \
  ...
  --config /work/nvme/becx/yjangir/flow_wm/configs/train_full_dit_8gpu.json
